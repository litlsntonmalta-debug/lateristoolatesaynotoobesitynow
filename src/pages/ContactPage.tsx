import { Mail, MapPin, Globe, Facebook } from "lucide-react";
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            {[
              { flag: "🇹🇷", name: "Mehmet Özoncel Anadolu Lisesi", city: "Adana, Türkiye" },
              { flag: "🇷🇴", name: "Palatul Copiilor", city: "Bacău, Romania" },
              { flag: "🇲🇹", name: "Alternative Learning Programme", city: "Paola, Malta" },
            ].map((s) => (
